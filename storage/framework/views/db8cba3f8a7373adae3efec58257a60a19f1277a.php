    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#product" aria-expanded="false" aria-controls="product">
          <span><i class="fa fa-archive fs-16"></i>Menus </span>
        </a>
        <ul id="product" class="collapse" aria-labelledby="product" data-parent="#side-nav-accordion">
          <li> <a href="product/productcata.html">Menu Catalogue</a> </li>
          <li> <a href="product/productlist.html">Product List</a> </li>
          <li> <a href="product/productgrid.html">Product Grid</a> </li>
          <li> <a href="product/addproduct.html">Add Product</a> </li>
          <li> <a href="product/productdetail.html">Product Detail</a> </li>
      ...
      <li class="menu-item">
        <a href="restaurants.html">
          <span><i class="fa fa-tasks fs-16"></i>Restaurants List</span>
        </a>
      </li>
      <!-- restaurants end -->
      ...
      <li class="menu-item">
        ...
        <ul id="customer" class="collapse" aria-labelledby="customer" data-parent="#side-nav-accordion">
          <li> <a href="../customer/customer/customersreview.html">Customers Review</a> </li>
          <li> <a href="../customer/customer/customersreview.html">Customers List</a> </li>
          <li> <a href="../customer/customer/social.html">Social Activity</a> </li>
      ...
      <li class="menu-item">
        <a href="sales.html">
          <span><i class="fa fa-briefcase fs-16"></i>Sales</span>
        </a>
      </li>
      ...
      <!--bonus  Pages -->
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#bonuspages" aria-expanded="false" aria-controls="bonuspages">
        ...
        <ul id="bonuspages" class="collapse" aria-labelledby="bonuspages" data-parent="#side-nav-accordion">
          ...
          <li> <a href="dashboard/project-management.html">Stock Management</a> </li>
...
<?php /**PATH G:\Laravel\ABest_One\abest_one\resources\views/orders/orders.blade.php ENDPATH**/ ?>